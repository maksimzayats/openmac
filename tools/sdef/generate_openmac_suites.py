...
def generate_bundle_module(target: AppTarget) -> str:
    lines = [
        "from __future__ import annotations",
        "",
        f"# Generated by {SCRIPT_PATH.relative_to(ROOT)}. Do not edit manually.",
        "",
        f"BUNDLE_ID = {render_py(target.bundle_id)}",
        "",
    ]
    return "\n".join(lines)
...
def generate_for_target(target: AppTarget) -> None:
    ...
    write_text(target.suites_dir.parent / "bundle.py", generate_bundle_module(target))
