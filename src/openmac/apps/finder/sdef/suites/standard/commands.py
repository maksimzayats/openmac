...
class OpenCommand(SDEFCommand[NoneType]):
...
class PrintCommand(SDEFCommand[NoneType]):
...
class QuitCommand(SDEFCommand[NoneType]):
    """Quit the Finder"""
...
class ActivateCommand(SDEFCommand[NoneType]):
...
class CloseCommand(SDEFCommand[NoneType]):
...
class CountCommand(SDEFCommand[int]):
...
class DataSizeCommand(SDEFCommand[int]):
...
class DeleteCommand(SDEFCommand[sdef_types.Specifier[SDEFClass]]):
...
class DuplicateCommand(SDEFCommand[sdef_types.Specifier[SDEFClass]]):
...
class ExistsCommand(SDEFCommand[bool]):
...
class MakeCommand(SDEFCommand[sdef_types.Specifier[SDEFClass]]):
...
class MoveCommand(SDEFCommand[sdef_types.Specifier[SDEFClass]]):
...
class SelectCommand(SDEFCommand[NoneType]):
