...
class CleanUpCommand(SDEFCommand[NoneType]):
...
class EjectCommand(SDEFCommand[NoneType]):
...
class EmptyCommand(SDEFCommand[NoneType]):
...
class EraseCommand(SDEFCommand[NoneType]):
...
class RevealCommand(SDEFCommand[NoneType]):
...
class UpdateCommand(SDEFCommand[NoneType]):
