...
class OpenVirtualLocationCommand(SDEFCommand[NoneType]):
...
class CopyCommand(SDEFCommand[NoneType]):
...
class SortCommand(SDEFCommand[sdef_types.Specifier[SDEFClass] | None]):
