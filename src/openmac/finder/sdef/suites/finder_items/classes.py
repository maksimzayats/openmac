...
class Item(SDEFClass):
    ...
    container: sdef_types.Specifier[SDEFClass] = Field(
        ...,
        alias="container",
        description="the container of the item",
    )
    disk: sdef_types.Specifier[SDEFClass] = Field(
        ...,
        alias="disk",
        description="the disk on which the item is stored",
    )
    ...
    icon: sdef_types.Specifier[TypeDefinitionsIconFamilyType] = Field(
        ...,
        alias="icon",
        description="the icon bitmap of the item",
    )
    ...
    information_window: sdef_types.Specifier[SDEFClass] = Field(
        ...,
...
Item.model_rebuild(_types_namespace=_CROSS_SUITE_TYPES_NAMESPACE)
